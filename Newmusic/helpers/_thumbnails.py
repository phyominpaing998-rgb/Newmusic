...
class Thumbnail:
    ...
    async def generate(self, song: Track) -> str:
        try:
            ...
            # 3. Contact Text
            contact = "If you want to create your own music bot, please contact @fisoz"
            ...
            # 8. Bottom Credit
            draw.text((self.size[0]//2, self.size[1] - 45), "Credit by @fisoz", font=self.font_credit, fill=(255, 255, 255, 180), anchor="ma")
